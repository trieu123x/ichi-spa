export const extendedServices = [
  // I. Liệu trình tái tạo năng lượng toàn thân
  {
    ...
    longDescription: {
      ...
      ko: "유기농 오일과 부드러운 마사지 기법을 결합하여 마음을 진정시키고 피로를 풀어주는 테라피입니다。",
      zh: "采用有机精油结合温和的按摩技巧，使精神舒缓，消除疲劳。"
    },
    benefits: {
  ...
  },
  {
    ...
    longDescription: {
      ...
      ko: "열을 유지하는 화산석을 사용하여 혈자리를 깊게 자극하고 막힌 에너지를 풀어줍니다。",
      zh: "使用蓄热火山石，深入作用于穴位，释放阻塞的能量。"
    },
    benefits: {
  ...
  },
  {
    ...
    longDescription: {
      ...
      ko: "따뜻하게 데워진 허브 백을 몸에 직접 압박하여 허브의 영양분이 깊숙이 흡수되도록 돕습니다。",
      zh: "药草包经蒸汽加热后直接轻轻按压于身体，使草本营深入渗透。"
    },
    benefits: {
  ...
  },
  {
    ...
    longDescription: {
      ...
      ko: "쑥뜸의 온기가 심부까지 전달되어 혈액순환을 돕고, 특히 스트레스와 전신 통증 해소에 효과적입니다。",
      zh: "艾条的热量有助于深层加温并改善循环，特别有助于缓解压力和全身酸痛。"
    },
    benefits: {
  ...
  // III. Liệu trình phục hồi chân
  {
    ...
    longDescription: {
      ...
      ko: "따뜻한 돌의 열기를 사용하여 수천 개의 신경 말단이 집중된 발의 혈액순환을 촉진합니다。",
      zh: "利用热石的热量刺激足部血液循环，足部拥有成千上万个神经末梢。"
    },
    benefits: {
  ...
  },
  {
    ...
    longDescription: {
      ...
      ko: "귀한 약재가 근육을 이완시키고 순환을 도와 장시간 서 있거나 발이 찬 분들에게 좋습니다。",
      zh: "名贵药材有助于软化肌肉并改善循环，非常适合久站或容易脚冷的人士。"
    },
    benefits: {
  ...
  // V. CHĂM SÓC DA MẶT
  {
    ...
    longDescription: {
      ...
      ko: "심층 클렌징을 통해 노폐물과 피지를 제거하고 얼굴에 투명함과 활력을 되찾아 줍니다。",
      zh: "深度清洁程序有助于去除污垢和皮脂，恢复面部的通透感与活力。"
    },
    benefits: {
  ...
  },
  {
    ...
    longDescription: {
      ...
      ko: "프리미엄 영양 성분과 리프팅 마사지 기법을 결합하여 허브의 정수가 피부에 완전히 흡수되도록 돕습니다。",
      zh: "结合高级营养成分与提拉按摩技巧，帮助肌肤充分吸收草本精华。"
    },
    benefits: {
  ...
  // VI. GỘI ĐẦU DƯỠNG SINH
  {
    ...
    longDescription: {
      ...
      ko: "수제 허브 워터로 두피를 세정하고 부드러운 자극을 통해 머리의 긴장을 풀어줍니다。",
      zh: "使用手工熬制的草本水清洁头皮，结合温柔的抓按动作，消除头部压力。"
    },
    benefits: {
  ...
  },
  {
    id: 'hair-neck',
    category: { vi: 'Gội Đầu', en: 'Hair Care', jp: 'ヘアケア', ko: '헤어 케어', zh: '洗头/美发' },
    name: { vi: "Gội cổ vai gáy", en: "Neck & Shoulder Wash", jp: "首・肩リラックスシャンプー", ko: "목/어깨 릴랙스 샴푸", zh: "颈肩洗发" },
    duration: { vi: "45 phút", en: "45 min", jp: "45 分", ko: "45 분", zh: "45 分钟" },
    price: { vi: "250.000", en: "250k", jp: "250k", ko: "250k", zh: "250k" },
    description: { vi: "Gội dưỡng sinh kết hợp massage.", en: "Hair wash combined with massage.", jp: "シャンプーとマッサージの融合。", ko: "샴푸와 마사지의 결합。", zh: "洗发结合按摩。" },
    longDescription: {
      ...
      ko: "단순한 샴푸를 넘어 목과 어깨 마사지에 집중하여 두 배의 휴식을 선사합니다。",
      zh: "不仅限于洗头，该疗程还专注于按摩颈肩部位，带来双重放松。"
    },
    benefits: {
  ...
  },
  {
    ...
    longDescription: {
      ...
      ko: "극도로 피로한 날을 위해 깊은 지압과 허브 에센스가 결합되어 막힌 기운을 완전히 풀어줍니다。",
      zh: "针对极度疲劳的日子，采用深度指压技术结合草本精华，帮助完全释放阻塞。"
    },
    benefits: {
